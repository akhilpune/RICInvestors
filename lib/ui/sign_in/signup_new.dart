...
import 'package:ricinvestors/services/auth.dart' as signupAuth;
import 'package:ricinvestors/services/auth_signup.dart';
  ...
  void _emailSignUp(
    ...
    if (_formKey.currentState.validate()) {
      try {
       ...
       //final auth = Provider.of<signupAuth.AuthBase>(context);
       ...
       //);
        Flushbar(
          ...
          message: "Account Created Successfully. Go Back To Login",
          duration: Duration(seconds: 5),
        )..show(context);
